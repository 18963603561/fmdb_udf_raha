...
> 本文为历史设计，完整快照方案已不再作为当前推荐。当前方案以 [Raha采样数据优先训练数据库设计-202607190950.md](../20260719/Raha采样数据优先训练数据库设计-202607190950.md) 为准：只保存采样结果 c1 和人工标签，训练时从原表读取 o1，不长期保存全量原始数据。
